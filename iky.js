//Cari Apa bg?
//gak ada apa" bg disini ke setting aja bg
// Di Ubah dikit eror 
//6285870935530
//Sv ya VinzBot
//Yt : VinzBot
//Note lEror jangan salahkan saya
const {
    WAConnection,
	MessageType,
	Presence,
      ...
      // GAME 
        ...
        if (game.isfam(from, family100)) {
          ...
          if (tebakata.hasOwnProperty(sender.split('@')[0]) && !isCmd) {
			...
			tc = `MAAF KA NOMER KAMU BLOM TERDAFTAR DI DATABASE SILAHKAN KETIK !verify UNTUK MENDAFTAR DI YT VinzBot☕`
			ind = {
...
𝙹𝙰𝙽𝙶𝙰𝙽 𝚂𝙿𝙰𝙼 𝙱𝙾𝚃,
𝙺𝙰𝚁𝙴𝙽𝙰 𝙱𝙾𝚃 𝙹𝚄𝙶𝙰 𝙿𝚄𝙽𝚈𝙰 𝙿𝙴𝚁𝙰𝚂𝙰𝙰𝙽
`
...
❏ ${prefix}wallgravity text1 text2
 `
sendButMessage(from, wibu, `created Free Bot`, [
          {
            buttonId: `!menu`,
            buttonText: {
...
`
                   sendButMessage(from, wibu, `Free Bot`, [
          {
            buttonId: `!menu`,
            buttonText: {
              displayText: `BACK TO MENU `,
...
`
        ...
        case 'simi':
				...
				buttons = [{buttonId: `!infoig`,buttonText:{displayText: ` Jangan Lupa Subscrib chanel yt VinzBot`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'YT VinzBot☕', imageMessage: imageMsg,
              contentText:`Jangan Subscrib chanel yt VinzBot \nAtau pencet link ini https://www.youtube.com/channel/UCsvR9uwJPmSvuyucQ2a-ELA`,buttons,headerType:4}
...
`
        ...
        case 'wasted':
		      ...
		      buttons = [{buttonId: `!infoig`,buttonText:{displayText: ` Jangan Lupa Subscrib chanel yt VinzBot \nAtau pencet link ini https://www.youtube.com/channel/UCsvR9uwJPmSvuyucQ2a-ELA`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'Subscrib chanel yt VinzBot☕', imageMessage: imageMsg,
              contentText:`Jangan Lupa Subscrib chanel yt VinzBot \nAtau pencet link ini https://www.youtube.com/channel/UCsvR9uwJPmSvuyucQ2a-ELA`,buttons,headerType:4}
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
              ikyy.relayWAMessage(prep)
break
				case 'quotesmaker':
...
anu = await fetchJson(`https://leyscoders-api.herokuapp.com/api/ppcouple?apikey=IkyOgiwara`)
						...
						buttons = [{buttonId: `!infoig`,buttonText:{displayText: `Jangan Subscrib chanel yt VinzBot \nAtau pencet link ini https://www.youtube.com/channel/UCsvR9uwJPmSvuyucQ2a-ELA`},type:1}]
...
case "mode":
        ...
        break;
	      case 'self':
              ...
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'Free Bot', imageMessage: imageMsg,
...
`
 ...
 Free Bot☕︎`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 1
}
...
Free Bot`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 1
}
...
Bantu suport saya di chanel https://www.youtube.com/channel/UCsvR9uwJPmSvuyucQ2a-ELA
...
*「 Free Bot☕ 」*`
	    ...
	    // console.log(e)
            setTimeout( () => {
			ikyy.updatePresence(from, Presence.composing)
			reply(`*Terimakasih Telah Mendaftar*`)
		}, 2000)
        break
case 'sfire':
{
...
//------------------< Premium >-------------------
       ...
       case 'buypremium':
       case 'sewabot':
              gopeynya = 'https://c.top4top.io/p_20920wutv0.jpg'
...
┃⬡ wa.me/6285870935530
┃⬡ Sv nama VinzBot
┃⬡ Yt https://www.youtube.com/channel/UCsvR9uwJPmSvuyucQ2a-ELA
┗━━⬣
NB : BOT ON 24 JAM KARNA DI RUN MENGGUNAKAN HATIMU
`
        ...
        "productSections": [
          {
            ...
            "products": [
              {
                "productId": "https://wa.me/p/6033578956712001/6281545463585"
              },
              {
              	"productId": "https://wa.me/p/6033578956712001/6281545463585"
              },
...
_Silahkan tunggu file media sedang dikirim mungkin butuh beberapa menit_`
              ...
              sendMediaURL(from, dl_link,`Nih Bantu Subscrib YT VinzBot kak`).catch(() => reply(mess.error.api))
})		
})
              } catch (err) {
              reply(`eror`)
      ...
      case 'kusonime':
       ...
       if (!isPremium) return sendButMessage (from, prem1, prem2, prem3, { quoted: freply})
        ...
        case 'otakuongoing':              
              ...
              buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️NEXT➡️`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'Jangan Lupa Subscrib chanel yt VinzBot \nAtau pencet link ini https://www.youtube.com/channel/UCsvR9uwJPmSvuyucQ2a-ELA Kak ☕', imageMessage: imageMsg,
              contentText:`klik Next untuk ke gambar selanjut nya`,buttons,headerType:4}
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
              ikyy.relayWAMessage(prep)
...
*[Wait] Tunggu Sebentar..*`
				...
				ikyy.sendMessage(from, buffer1, video, {mimetype: 'video/mp4', filename: `${anu.result.video}.mp4`, quoted:freply, caption: 'Nih Bantu Subscrib YT VinzBot'})
					break  
...
break
      ...
      case 'toimg':
              ...
              ikyy.sendMessage(from, buffer, image, {quoted: freply, caption: 'Nih Bantu Subscrib YT VinzBot'})
              fs.unlinkSync(ran)
})
              break
       case 'smeme': 
...
//------------------< Ingfo Bot >-------------------
      case 'runtime':
       ...
       case 'sc': 
       case 'src':
              textImg(`Bot ini menggunakan sc : https://www.youtube.com/channel/UCsvR9uwJPmSvuyucQ2a-ELA`)
              break
      case 'ping':
      case 'speed':
              timestampe = speed();
...
//------------------< Owner >-------------------
      ...
      case 'broadcast':
             ...
             for (let _ of anu) {
             ikyy.sendMessage(_.jid, bc, image, {quoted:freply,caption: `*「 YT VinzBot☕ NEWS 」*\n\n${body.slice(4)}`})
}
             reply('Suksess broadcast')
             } else {
             for (let _ of anu) {
             sendMess(_.jid, `*「 *BOARDCAST* 」*\n\n${body.slice(4)}`)
}
             reply('Suksess broadcast')
}
             break
...
ikyy.sendMessage(_.jid, 
			{"contentText": `*「 Free Bot 」*\n\n${body.slice(4)}`,
			"footerText": 'Enjoy Lurr☕',
			"buttons": [
			{"buttonId": `#command`,
...
//------------------< Fun >-------------------
       ...
       case 'nilai':
              ...
              break
      case 'bay':
      reply('Sayonara buat yang pergi😔\n Semoga amal ibadahnya di terima :) \nBantu suport saya Subscrib chanel yt VinzBot \nAtau pencet link ini https://www.youtube.com/channel/UCsvR9uwJPmSvuyucQ2a-ELA')
      break
      case 'selamatdatang':
...
//------------------< Lainnya >-------------------
        case 'getpp':
               ...
               ikyy.sendMessage(from, buffer, image, {caption: "Nih Bantu Subscrib YT VinzBot", quoted: freply })
...
//------------------< Menunya Bang:v >-------------------
      case 'infoig':
             reply(`Jangan Lupa SUBSCRIBE CHANEL OWNER YA 🙏 : https://www.youtube.com/channel/UCsvR9uwJPmSvuyucQ2a-ELA`)
             break
      case 'ikyygroup':
             reply('https://chat.whatsapp.com/ImqvWVYNJJW7rhZPHDpTwF\nJangan Lupa Join Ya Kak ${pushname}')
             break

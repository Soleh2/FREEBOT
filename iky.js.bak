...
const isImage = (type === 'imageMessage')
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
      ...
      const daftar1 = `Hai kak  ${pushname} ${ucapanWaktu} \n\nSebelum Menggunakan DIDINBOT☕Verify Terlebih Dahulu Ya `
...
`
                    ...
                    ikyy.sendMessage(from, { contentText: `${menu}`, footerText: 'DIDINBOT☕', buttons: [{ buttonId: `!command`, buttonText: { displayText: '📙MENU' }, type: 1 },{ buttonId: `!sewabot`, buttonText: { displayText: '🏷️ SEWA BOT' }, type: 1 },{ buttonId: `!owner`, buttonText: { displayText: '👥 OWNER' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: ikyads, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
case 'f':
case 'lock':
 ikymemek = {
...
🔖 ${prefix}wallgravity text1 text2
 `
sendButMessage(from, wibu, `created DIDINBOT☕`, [
          {
            buttonId: `!menu`,
            buttonText: {
...
`
                   sendButMessage(from, wibu, `DIDINXD☕`, [
          {
            buttonId: `!menu`,
            buttonText: {
              displayText: `⬡ BACK TO MENU `,
...
`
        ...
        case 'simi':
              ...
              buttonsMessage = {footerText:'DIDINBOT☕', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @Didin_yt1`,buttons,headerType:4}
...
`
 ...
 DIDINBOT☕︎`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 1
}
...
`
 ...
 DIDINBOT☕`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 1
}
...
//------------------< Ingfo Bot >-------------------
      case 'runtime':
       ...
       case 'sc': 
       case 'src':
              textImg(`Bot ini menggunakan sc : https://github.com/didinxd/`)
              break
      case 'ping':
      case 'speed':
              timestampe = speed();
...
//------------------< Owner >-------------------
      ...
      case 'broadcast':
             ...
             for (let _ of anu) {
             ikyy.sendMessage(_.jid, bc, image, {quoted:freply,caption: `*「 DIDINBOT☕ NEWS 」*\n\n${body.slice(4)}`})
}
             reply('Suksess broadcast')
             } else {
             for (let _ of anu) {
             sendMess(_.jid, `*「 DIDINBOT☕ NEWS 」*\n\n${body.slice(4)}`)
}
             reply('Suksess broadcast')
}
             break
...
//------------------< Menunya Bang:v >-------------------
      case 'infoig':
             reply(`Jangan Lupa Follow Ig Owner Ya : https://www.instagram.com/Didin_yt1/`)
             break
      case 'ikyygroup':
